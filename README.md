...
running command...
$ ai (--version)
@offline-ai/cli/0.5.2 linux-x64 node-v20.14.0
$ ai --help [COMMAND]
USAGE
  $ ai COMMAND
...
...
_See code: [src/commands/agent/index.ts](https://github.com/offline-ai/cli/blob/v0.5.2/src/commands/agent/index.ts)_
