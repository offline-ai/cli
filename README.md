...
running command...
$ ai (--version)
@offline-ai/cli/0.9.0 linux-x64 node-v20.18.0
$ ai --help [COMMAND]
USAGE
  $ ai COMMAND
...
...
_See code: [src/commands/agent/index.ts](https://github.com/offline-ai/cli/blob/v0.9.0/src/commands/agent/index.ts)_
