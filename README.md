...
_See code: [src/commands/agent/index.ts](https://github.com/offline-ai/ai/blob/v0.0.1/src/commands/agent/index.ts)_
...
_See code: [src/commands/brain/index.ts](https://github.com/offline-ai/ai/blob/v0.0.1/src/commands/brain/index.ts)_
...
_See code: [src/commands/brain/download.ts](https://github.com/offline-ai/ai/blob/v0.0.1/src/commands/brain/download.ts)_
...
_See code: [src/commands/brain/list.ts](https://github.com/offline-ai/ai/blob/v0.0.1/src/commands/brain/list.ts)_
...
_See code: [src/commands/config/index.ts](https://github.com/offline-ai/ai/blob/v0.0.1/src/commands/config/index.ts)_
...
_See code: [src/commands/config/save.ts](https://github.com/offline-ai/ai/blob/v0.0.1/src/commands/config/save.ts)_
...
_See code: [src/commands/run/index.ts](https://github.com/offline-ai/ai/blob/v0.0.1/src/commands/run/index.ts)_
