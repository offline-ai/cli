...
running command...
$ ai (--version)
@offline-ai/cli/0.4.0 linux-x64 node-v20.14.0
$ ai --help [COMMAND]
USAGE
  $ ai COMMAND
...
...
_See code: [src/commands/agent/index.ts](https://github.com/offline-ai/cli/blob/v0.4.0/src/commands/agent/index.ts)_
...
_See code: [@offline-ai/cli-plugin-cmd-brain](https://github.com/offline-ai/cli-plugin-cmd-brain.js/blob/v0.3.9/src/commands/brain/index.ts)_
...
_See code: [@offline-ai/cli-plugin-cmd-brain](https://github.com/offline-ai/cli-plugin-cmd-brain.js/blob/v0.3.9/src/commands/brain/download.ts)_
...
_See code: [@offline-ai/cli-plugin-cmd-brain](https://github.com/offline-ai/cli-plugin-cmd-brain.js/blob/v0.3.9/src/commands/brain/list.ts)_
...
_See code: [@offline-ai/cli-plugin-cmd-brain](https://github.com/offline-ai/cli-plugin-cmd-brain.js/blob/v0.3.9/src/commands/brain/refresh.ts)_
...
_See code: [@offline-ai/cli-plugin-cmd-brain](https://github.com/offline-ai/cli-plugin-cmd-brain.js/blob/v0.3.9/src/commands/brain/search.ts)_
...
_See code: [@offline-ai/cli-plugin-cmd-config](https://github.com/offline-ai/cli-plugin-cmd-config.js/blob/v0.1.11/src/commands/config/index.ts)_
...
_See code: [@offline-ai/cli-plugin-cmd-config](https://github.com/offline-ai/cli-plugin-cmd-config.js/blob/v0.1.11/src/commands/config/save.ts)_
...
_See code: [@offline-ai/cli-plugin-cmd-test](https://github.com/offline-ai/cli-plugin-cmd-test.js/blob/v0.1.10/src/commands/test/index.ts)_
