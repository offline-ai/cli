...
running command...
$ ai (--version)
@offline-ai/cli/0.0.2 linux-x64 node-v20.14.0
$ ai --help [COMMAND]
USAGE
  $ ai COMMAND
...
...
_See code: [src/commands/agent/index.ts](https://github.com/offline-ai/ai/blob/v0.0.2/src/commands/agent/index.ts)_
...
_See code: [src/commands/brain/index.ts](https://github.com/offline-ai/ai/blob/v0.0.2/src/commands/brain/index.ts)_
...
_See code: [src/commands/brain/download.ts](https://github.com/offline-ai/ai/blob/v0.0.2/src/commands/brain/download.ts)_
...
_See code: [src/commands/brain/list.ts](https://github.com/offline-ai/ai/blob/v0.0.2/src/commands/brain/list.ts)_
...
_See code: [src/commands/config/index.ts](https://github.com/offline-ai/ai/blob/v0.0.2/src/commands/config/index.ts)_
...
_See code: [src/commands/config/save.ts](https://github.com/offline-ai/ai/blob/v0.0.2/src/commands/config/save.ts)_
...
_See code: [src/commands/run/index.ts](https://github.com/offline-ai/ai/blob/v0.0.2/src/commands/run/index.ts)_
